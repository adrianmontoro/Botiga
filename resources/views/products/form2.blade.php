...
<div class="" style="text-align: center;">
    ...
    {{Form::text('nom',$product->name,['class' =>'form-controller', 'placeholder'=>'Titulo...'])}}</div>
    <div class="form-group">
    {{Form::textarea('description',$product->description,['class' =>'form-controller', 'placeholder'=>'Descripcio...'])}}</div>
    <div class="form-group">
